...
///////////////////////////////////////////////////////////////////////////////
		...
		$this->dbUser     = "cydia";       //The username to login as.
		$this->dbPassword = "cydia-1337";         //The database password.
		$this->dbDatabase = "cydia";     //The database to utilize.
...
///////////////////////////////////////////////////////////////////////////////
	...
	function ensureTables() {
		...
		$SQL_CREATE_RATABLES = "CREATE TABLE $this->ratables (
			...
			`ratableKey` varchar(300) NOT NULL,
